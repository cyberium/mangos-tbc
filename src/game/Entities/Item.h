...
class Item : public Object
{
    public:
        ...
        bool HasGeneratedLoot() const { return m_loot2 && m_lootState != ITEM_LOOT_NONE && m_lootState != ITEM_LOOT_REMOVED; }
        bool HasTemporaryLoot() const { return m_loot2 && m_lootState == ITEM_LOOT_TEMPORARY; }
